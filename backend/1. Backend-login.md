...
# V1.1 Deploy server into Lambda function
- uses @vendia/serverless-express to wrap express app into lambda handler
- Add an debounceTimer to the sync, preventing flood requests